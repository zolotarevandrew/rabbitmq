...
public class ConsumerFanoutExchange : BackgroundService
{
    private readonly ILogger<ConsumerFanoutExchange> _logger;
    private IConnection? _connection;
    private IChannel? _channel;

    public ConsumerFanoutExchange(ILogger<ConsumerFanoutExchange> logger)
    {
        _logger = logger;
    }
    ...
    public override async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        await _channel.QueueBindAsync(queue: queueName, exchange: "logs", routingKey: string.Empty, cancellationToken: cancellationToken);
