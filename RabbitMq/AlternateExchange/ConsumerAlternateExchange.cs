...
public class ConsumerAlternateExchange : BackgroundService
{
    private readonly ILogger<ConsumerFanoutExchange> _logger;
    private IConnection? _connection;
    private IChannel? _channel;

    public ConsumerAlternateExchange(ILogger<ConsumerFanoutExchange> logger)
    {
        _logger = logger;
    }
